        ...
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    ...
                    <h3>Highest products based on customer's choice</h3>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="product-carousel">
                    ...
                    <?php
                    $statement = $pdo->prepare("SELECT * FROM tbl_product WHERE p_is_active=? ORDER BY p_qty LIMIT ".$total_popular_product_home);
                        //  $statement=$pdo->prepare("SELECT max(p_qty)FROM tbl_product");
