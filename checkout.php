...
<div class="page">
                ...
                <div class="cart">
                    <table class="table table-responsive table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            $_SESSION['pname'] = $arr_cart_p_name[$i];
                            ?>
                            </td>

                            <td><?php echo $arr_cart_size_name[$i]; 
                            $_SESSION['psize'] = $arr_cart_size_name[$i];
                            ?></td>
                            <td><?php echo $arr_cart_color_name[$i];
                            $_SESSION['pcolour'] = $arr_cart_color_name[$i];
                            ?></td>
                            <td><?php echo LANG_VALUE_1; ?><?php echo $arr_cart_p_current_price[$i];
                            $_SESSION['pcprice'] = $arr_cart_p_current_price[$i];
                            ?></td>
                            <td><?php echo $arr_cart_p_qty[$i]; 
                            $_SESSION['pqty'] = $arr_cart_p_qty[$i];
                            ?></td>
                            <td class="text-right">
                                <?php
                                ...
                                $_SESSION['ptotprice'] = $row_total_price;
                                ?>
                            </td>
                        </tr>
                        <?php endfor; ?>           
                        ...
                        <tr>
                            ...
                            <th class="total-amount">
                                ...
                                $_SESSION['grandtotal'] = $final_total;
                                ?>
		                	...
		                	<div class="col-md-4">
	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-12 form-group">
	                                    <a href="payment/paypal/payment_process.php"><input type="button" value="Checkout Now" class="btn btn-danger"></a>
	                                </div>
    ...
    <?php for($i = 0; $i < count($arr_cart_p_name); $i++): 
        echo htmlspecialchars($arr_cart_p_name[$i]);?>
        <input type="hidden" name="cart_items[<?php echo $i; ?>][id]" value="<?php echo $i; ?>">
        <input type="hidden" name="cart_items[<?php echo $i; ?>][photo]" value="<?php echo htmlspecialchars($arr_cart_p_featured_photo[$i]); ?>">
        <input type="hidden" name="cart_items[<?php echo $i; ?>][name]" value="<?php echo htmlspecialchars($arr_cart_p_name[$i]); ?>">
        <input type="hidden" name="cart_items[<?php echo $i; ?>][size]" value="<?php echo htmlspecialchars($arr_cart_size_name[$i]); ?>">
        <input type="hidden" name="cart_items[<?php echo $i; ?>][color]" value="<?php echo htmlspecialchars($arr_cart_color_name[$i]); ?>">
        <input type="hidden" name="cart_items[<?php echo $i; ?>][price]" value="<?php echo htmlspecialchars($arr_cart_p_current_price[$i]); ?>">
        <input type="hidden" name="cart_items[<?php echo $i; ?>][qty]" value="<?php echo htmlspecialchars($arr_cart_p_qty[$i]); ?>">
        <input type="hidden" name="cart_items[<?php echo $i; ?>][row_total_price]" value="<?php echo $arr_cart_p_current_price[$i] * $arr_cart_p_qty[$i]; ?>">
    <?php endfor; ?>
    <input type="hidden" name="table_total_price" value="<?php echo $table_total_price; ?>">
